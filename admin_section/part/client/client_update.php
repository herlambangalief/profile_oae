  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Client Data</li>
      </ol>
    ...
    <div class="box_general padding_bottom">
      <div class="header_box version_2">
        <h2><i class="fa fa-address-card"></i>Edit Client Data</h2>
      </div>
      <div class="row"> 
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" required name="company_name" value="<?php echo $data['company_name']; ?>">
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- /box_general-->
    <p>
      <input type="submit" name="edit_client" class="btn btn-primary" value="Change">
